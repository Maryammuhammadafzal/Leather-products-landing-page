    ...
    <div className="w-full h-auto flex justify-center items-center md:py-20 sm:py-14 xs:py-8 py-4">
      <div className="grid grid-rows-2 justify-center items-center w-full h-auto">
        <div className="grid xs:grid-cols-3 grid-cols-2 w-full h-auto justify-center items-center">
          ...
          <div id="jackets" className="w-full xl:h-[600px] lg:h-[530px] md:h-[450px] sm:h-[380px] xs:h-[300px] h-[220px] group relative">
            <Image
          ...
          <div id="ladies-bag" className="w-full xl:h-[600px] lg:h-[530px] md:h-[450px] sm:h-[380px] xs:h-[300px] xs:block hidden h-[220px] group relative">
            <Image
        ...
        <div className="grid grid-cols-2 w-full h-auto justify-center items-center">
          <div id="bags" className="w-full xl:h-[600px] lg:h-[530px] md:h-[450px] sm:h-[380px] xs:h-[300px] h-[220px] group relative">
            <Image
          ...
          <div id="watches" className="w-full xl:h-[600px] lg:h-[530px] md:h-[450px] sm:h-[380px] xs:h-[300px] h-[220px] group relative">
            <Image
